---
name: astro-seo
description: Imported skill package from starter-bundle: astro-seo. Review and refine before production use.
source_group: skills
imported_from: astro-seo.md
---
...
titleTemplate | string | Provide a title template to keep a consistent title style. `%s Ã¢â‚¬â€ Astro SEO`, `%s` will be replaced with your title, e.g. `Homepage Ã¢â‚¬â€ Astro SEO`
...
twitter.card | TwitterCardType (string) | Sets `twitter:card`. The card type. Must be one of Ã¢â‚¬Å“summaryÃ¢â‚¬Â, Ã¢â‚¬Å“summary_large_imageÃ¢â‚¬Â, Ã¢â‚¬Å“appÃ¢â‚¬Â, or Ã¢â‚¬Å“playerÃ¢â‚¬Â.
...
and all the amazing work Gary is doing developing it. Thanks Gary! Ã¢ÂÂ¤Ã¯Â¸Â
