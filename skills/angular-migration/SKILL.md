...
source_group: skills
imported_from: angular-migration.md
---
...
### AngularJS Controller Ã¢â€ â€™ Angular Component
```javascript
...
### AngularJS Directive Ã¢â€ â€™ Angular Component
```javascript
...
### Downgrading Angular Ã¢â€ â€™ AngularJS
```typescript
// Angular service
import { Injectable } from '@angular/core';
...
### Upgrading AngularJS Ã¢â€ â€™ Angular
```typescript
// AngularJS service
