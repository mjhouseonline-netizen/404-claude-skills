...
description: |
source_group: skills
imported_from: azure-monitor-ingestion-py.md
...
1. **Log Analytics Workspace** Ã¢â‚¬â€ Target for your logs
2. **Data Collection Endpoint (DCE)** Ã¢â‚¬â€ Ingestion endpoint
3. **Data Collection Rule (DCR)** Ã¢â‚¬â€ Defines schema and destination
4. **Custom Table** Ã¢â‚¬â€ In Log Analytics (created via DCR or manually)
...
| Concept | Description |
|---------|-------------|
| **DCE** | Data Collection Endpoint Ã¢â‚¬â€ ingestion URL |
| **DCR** | Data Collection Rule Ã¢â‚¬â€ defines schema, transformations, destination |
...
- `Custom-<TableName>_CL` Ã¢â‚¬â€ For custom tables
- `Microsoft-<TableName>` Ã¢â‚¬â€ For built-in tables

## Best Practices

1. **Use DefaultAzureCredential** for authentication
2. **Handle errors gracefully** Ã¢â‚¬â€ use `on_error` callback for partial failures
3. **Include TimeGenerated** Ã¢â‚¬â€ Required field for all logs
4. **Match DCR schema** Ã¢â‚¬â€ Log fields must match DCR column definitions
5. **Use async client** for high-throughput scenarios
6. **Batch uploads** Ã¢â‚¬â€ SDK handles batching, but send reasonable chunks
7. **Monitor ingestion** Ã¢â‚¬â€ Check Log Analytics for ingestion status
8. **Use context manager** Ã¢â‚¬â€ Ensures proper client cleanup
