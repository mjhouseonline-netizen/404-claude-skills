...
source_group: skills
imported_from: ai-shaped-readiness-advisor.md
type: interactive
---
...
This is not about AI toolsÃ¢â‚¬â€it's about **organizational redesign around AI as co-intelligence**. The interactive skill guides you through a maturity assessment, then recommends your next move.
...
**Critical Insight:** If a competitor can replicate your AI usage by throwing bodies at it, it's not differentiationÃ¢â‚¬â€it's just efficiency (which becomes table stakes within months).
...
#### 1. **Context Design**
Building a durable **"reality layer"** that both humans and AI can trustÃ¢â‚¬â€treating AI attention as a scarce resource and allocating it deliberately.
...
**AI-shaped version:** CLAUDE.md files, evidence databases, constraint registries AI agents reference; two-layer memory architecture; ResearchÃ¢â€ â€™PlanÃ¢â€ â€™ResetÃ¢â€ â€™Implement cycle to prevent context rot
...
**What it includes:**
- Defined workflow loops: research Ã¢â€ â€™ synthesis Ã¢â€ â€™ critique Ã¢â€ â€™ decision Ã¢â€ â€™ log rationale
...
- Decision authority (AI recommends, humans decideÃ¢â‚¬â€clear boundaries)
...
**AI-shaped version:** "We validate product hypotheses in 2 days vs. industry standard 3 weeksÃ¢â‚¬â€ship 6x more validated features per quarter"
...
1. Guided mode: IÃ¢â‚¬â„¢ll ask one question at a time.
2. Context dump: you paste what you already know, and IÃ¢â‚¬â„¢ll skip anything redundant.
3. Best guess mode: IÃ¢â‚¬â„¢ll make reasonable assumptions where details are missing, label them, and keep moving."
...
Let's assess your **Context Design** capabilityÃ¢â‚¬â€how well you've built a "reality layer" that both humans and AI can trust, and whether you're doing **context stuffing** (volume without intent) or **context engineering** (structure for attention).
...
3. **Level 3 (Transitioning / Context Engineering Emerging):** "We've started using CLAUDE.md files and project instructions. Constraints registry exists. We're identifying what to persist vs. retrieve. Experimenting with ResearchÃ¢â€ â€™PlanÃ¢â€ â€™ResetÃ¢â€ â€™Implement cycle."
...
4. **Level 4 (AI-Shaped / Context Engineering Mastery):** "We maintain a durable reality layer: constraints registry (20+ entries), evidence database, operational glossary (30+ terms). Two-layer memory architecture (short-term conversational + long-term persistent via vector DB). Context boundaries defined and owned. AI agents reference these automatically. We use ResearchÃ¢â€ â€™PlanÃ¢â€ â€™ResetÃ¢â€ â€™Implement to prevent context rot."
   ...
   - **Context Engineering Mastery:** Can answer all 5 diagnostic questions; context boundary audited quarterly; quantitative efficiency tracking: (Accuracy Ãƒâ€” Coherence) / (Tokens Ãƒâ€” Latency)
...
Now let's assess **Agent Orchestration**Ã¢â‚¬â€whether you have repeatable AI workflows or just one-off prompts.
...
3. **Level 3 (Transitioning):** "We've built some multi-step workflows (research Ã¢â€ â€™ synthesis Ã¢â€ â€™ critique). Tracked in tools like Notion or Linear."
   - Reality: Workflows exist but require manual handoffs
   - Problem: Still human-in-the-loop for every step; not fully automated

4. **Level 4 (AI-Shaped):** "We have orchestrated AI workflows that run autonomously: research Ã¢â€ â€™ synthesis Ã¢â€ â€™ critique Ã¢â€ â€™ decision Ã¢â€ â€™ log rationale. Each step is traceable and version-controlled."
...
Next, **Outcome Acceleration**Ã¢â‚¬â€are you using AI to compress learning cycles, or just speed up tasks?
...
Now assess **Team-AI Facilitation**Ã¢â‚¬â€how well you've redesigned team systems for AI as co-intelligence.
...
Finally, **Strategic Differentiation**Ã¢â‚¬â€are you creating defensible competitive advantages, or just efficiency gains?
...
Ã¢â€â€š Competency                  Ã¢â€â€š Level Ã¢â€â€š Maturity Ã¢â€â€š
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â¼Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â¼Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â¤
Ã¢â€â€š 1. Context Design           Ã¢â€â€š   X   Ã¢â€â€š [Label]  Ã¢â€â€š
Ã¢â€â€š 2. Agent Orchestration      Ã¢â€â€š   X   Ã¢â€â€š [Label]  Ã¢â€â€š
Ã¢â€â€š 3. Outcome Acceleration     Ã¢â€â€š   X   Ã¢â€â€š [Label]  Ã¢â€â€š
Ã¢â€â€š 4. Team-AI Facilitation     Ã¢â€â€š   X   Ã¢â€â€š [Label]  Ã¢â€â€š
Ã¢â€â€š 5. Strategic DifferentiationÃ¢â€â€š   X   Ã¢â€â€š [Label]  Ã¢â€â€š
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â´Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â´Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Ëœ
...
**Dependency Logic:**
1. **Context Design is foundational** Ã¢â‚¬â€ If Level 1-2, this must be priority #1 (Agent Orchestration and Outcome Acceleration depend on it)
2. **Agent Orchestration enables Outcome Acceleration** Ã¢â‚¬â€ If Context Design is Level 3+, but Agent Orchestration is Level 1-2, prioritize orchestration
3. **Team-AI Facilitation is parallel** Ã¢â‚¬â€ Can be developed alongside others, but required for scale
4. **Strategic Differentiation requires Levels 3+ on others** Ã¢â‚¬â€ Don't focus here until foundational competencies are built
...
**Options:**
1. **Accept recommendation** Ã¢â‚¬â€ [Agent provides detailed action plan]
2. **Choose different priority** Ã¢â‚¬â€ [Agent warns about dependencies but allows override]
3. **Focus on multiple simultaneously** Ã¢â‚¬â€ [Agent suggests parallel tracks if feasible]
...
**Goal:** Build a durable "reality layer" that both humans and AI trustÃ¢â‚¬â€move from context stuffing to context engineering.
...
2. **Implement ResearchÃ¢â€ â€™PlanÃ¢â€ â€™ResetÃ¢â€ â€™Implement cycle:**
...
**Success Criteria:**
- Ã¢Å“â€¦ Constraints registry has 20+ entries
- Ã¢Å“â€¦ Operational glossary has 20-30 terms
- Ã¢Å“â€¦ Evidence standards documented and shared
- Ã¢Å“â€¦ Context Manifest created (always-needed vs. episodic)
- Ã¢Å“â€¦ Context boundary owner assigned
- Ã¢Å“â€¦ Two-layer memory architecture implemented
- Ã¢Å“â€¦ ResearchÃ¢â€ â€™PlanÃ¢â€ â€™ResetÃ¢â€ â€™Implement cycle tested on 1 workflow
- Ã¢Å“â€¦ AI agents reference these automatically
- Ã¢Å“â€¦ Token usage down 30%+ (less context stuffing)
- Ã¢Å“â€¦ Output consistency up (fewer retries)

**Related Skills:**
- **[`context-engineering-advisor`](../context-engineering-advisor/SKILL.md)** (Interactive) Ã¢â‚¬â€ Deep dive on diagnosing context stuffing and implementing memory architecture
- `problem-statement.md` Ã¢â‚¬â€ Define constraints before framing problems
- `epic-hypothesis.md` Ã¢â‚¬â€ Evidence-based hypothesis writing
...
**Success Criteria:**
- Ã¢Å“â€¦ At least 1 workflow runs consistently (same inputs Ã¢â€ â€™ predictable process)
- Ã¢Å“â€¦ Each step is traceable (AI cites sources)
- Ã¢Å“â€¦ Team can replicate workflow without your involvement

**Related Skills:**
- `pol-probe-advisor.md` Ã¢â‚¬â€ Use orchestrated workflows for validation experiments
...
1. Map your current learning cycle (e.g., hypothesis Ã¢â€ â€™ experiment Ã¢â€ â€™ analysis Ã¢â€ â€™ decision)
2. Time each step
...
**Success Criteria:**
- Ã¢Å“â€¦ Learning cycle compressed by 50%+ on at least 1 initiative
- Ã¢Å“â€¦ Quality maintained (no shortcuts that compromise rigor)
- Ã¢Å“â€¦ Team adopts the accelerated workflow

**Related Skills:**
- `pol-probe.md` Ã¢â‚¬â€ Use AI to run PoL probes faster
- `discovery-process.md` Ã¢â‚¬â€ Compress discovery cycles with AI
...
**Success Criteria:**
- Ã¢Å“â€¦ Review norms documented and followed by team
- Ã¢Å“â€¦ Evidence standards codified
- Ã¢Å“â€¦ Decision authority clear
- Ã¢Å“â€¦ Team comfortable challenging AI outputs

**Related Skills:**
- `problem-statement.md` Ã¢â‚¬â€ Evidence-based problem framing
- `epic-hypothesis.md` Ã¢â‚¬â€ Testable, evidence-backed hypotheses
...
**Success Criteria:**
- Ã¢Å“â€¦ Identified at least 1 AI-enabled capability competitors can't easily copy
- Ã¢Å“â€¦ Validated with customers (they see the value)
- Ã¢Å“â€¦ Confirmed defensibility (competitor analysis)

**Related Skills:**
- `positioning-statement.md` Ã¢â‚¬â€ Articulate your AI-driven differentiation
- `jobs-to-be-done.md` Ã¢â‚¬â€ Understand what customers hire your AI capabilities to do
...
**Options:**
1. **Yes, create tracker** Ã¢â‚¬â€ [Agent generates Markdown checklist]
2. **No, I'll track separately** Ã¢â‚¬â€ [Agent provides summary]

---

## Examples

### Example 1: Early-Stage Startup (AI-First Ã¢â€ â€™ Emerging)
...
**Outcome:** After 4 weeks, Context Design Ã¢â€ â€™ Level 3. Unlocks Agent Orchestration next quarter.

---

### Example 2: Growth-Stage Company (Transitioning Ã¢â€ â€™ AI-Shaped)
...
**Outcome:** Learning cycles 5x faster Ã¢â€ â€™ strategic separation from competitors Ã¢â€ â€™ Level 4 Outcome Acceleration + Level 3 Strategic Differentiation.
...
**Outcome:** Team-AI Facilitation Ã¢â€ â€™ Level 3. Creates foundation for Context Design and Agent Orchestration next.
...
**Failure Mode:** "We use AI to write PRDs 2x fasterÃ¢â‚¬â€we're AI-shaped!"
...
### Related Skills
- **[context-engineering-advisor](../context-engineering-advisor/SKILL.md)** (Interactive) Ã¢â‚¬â€ **Deep dive on Context Design competency:** Diagnose context stuffing, implement memory architecture, use ResearchÃ¢â€ â€™PlanÃ¢â€ â€™ResetÃ¢â€ â€™Implement cycle
- **[problem-statement](../problem-statement/SKILL.md)** (Component) Ã¢â‚¬â€ Evidence-based problem framing (Context Design)
- **[epic-hypothesis](../epic-hypothesis/SKILL.md)** (Component) Ã¢â‚¬â€ Testable hypotheses with evidence standards
- **[pol-probe-advisor](../pol-probe-advisor/SKILL.md)** (Interactive) Ã¢â‚¬â€ Use AI to compress validation cycles (Outcome Acceleration)
- **[discovery-process](../discovery-process/SKILL.md)** (Workflow) Ã¢â‚¬â€ Apply AI-shaped principles to discovery
- **[positioning-statement](../positioning-statement/SKILL.md)** (Component) Ã¢â‚¬â€ Articulate your AI-driven differentiation (Strategic Differentiation)

### External Frameworks
- **Dean Peters** Ã¢â‚¬â€ [*AI-First Is Cute. AI-Shaped Is Survival.*](https://deanpeters.substack.com/p/ai-first-is-cute-ai-shaped-is-survival) (Dean Peters' Substack, 2026)
- **Dean Peters** Ã¢â‚¬â€ [*Context Stuffing Is Not Context Engineering*](https://deanpeters.substack.com/p/context-stuffing-is-not-context-engineering) (Dean Peters' Substack, 2026) Ã¢â‚¬â€ Deep dive on Competency #1 (Context Design)

### Further Reading
- **Ethan Mollick** Ã¢â‚¬â€ *Co-Intelligence* (on AI as co-intelligence, not replacement)
- **Shreyas Doshi** Ã¢â‚¬â€ Twitter threads on PM judgment augmentation with AI
- **Lenny Rachitsky** Ã¢â‚¬â€ Newsletter interviews with AI-forward PMs
