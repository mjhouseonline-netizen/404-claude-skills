...
description: |
source_group: skills
imported_from: azure-resource-manager-redis-dotnet.md
...
> **Ã¢Å¡Â Ã¯Â¸Â Management vs Data Plane**
...
```
ArmClient
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ SubscriptionResource
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ResourceGroupResource
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ RedisResource
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ RedisFirewallRuleResource
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ RedisPatchScheduleResource
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ RedisLinkedServerWithPropertyResource
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ RedisPrivateEndpointConnectionResource
            Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ RedisCacheAccessPolicyResource
```
...
3. **Always use `DefaultAzureCredential`** Ã¢â‚¬â€ never hardcode keys
...
8. **Enable TLS 1.2 minimum** Ã¢â‚¬â€ set `MinimumTlsVersion = RedisTlsVersion.Tls1_2`
9. **Disable non-SSL port** Ã¢â‚¬â€ set `EnableNonSslPort = false` for security
10. **Rotate keys regularly** Ã¢â‚¬â€ use `RegenerateKeyAsync` and update connection strings
...
1. **SKU downgrades not allowed** Ã¢â‚¬â€ You cannot downgrade from Premium to Standard/Basic
2. **Clustering requires Premium** Ã¢â‚¬â€ Shard configuration only available on Premium SKU
3. **Geo-replication requires Premium** Ã¢â‚¬â€ Linked servers only work with Premium caches
4. **VNet injection requires Premium** Ã¢â‚¬â€ Virtual network support is Premium-only
5. **Patch schedules require Premium** Ã¢â‚¬â€ Maintenance windows only configurable on Premium
6. **Cache name globally unique** Ã¢â‚¬â€ Redis cache names must be unique across all Azure subscriptions
7. **Long provisioning times** Ã¢â‚¬â€ Cache creation can take 15-20 minutes; use `WaitUntil.Started` for async patterns
