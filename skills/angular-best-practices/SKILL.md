...
description: Imported skill package from starter-bundle: angular-best-practices. Review and refine before production use.
source_group: skills
imported_from: angular-best-practices.md
---
...
- Ã¢ÂÅ’ **WRONG** - What not to do
- Ã¢Å“â€¦ **CORRECT** - Recommended pattern
- Ã°Å¸â€œÂ **Why** - Explanation of the impact
