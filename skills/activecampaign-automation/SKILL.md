...
source_group: skills
imported_from: activecampaign-automation.md
requires:
  mcp: [rube]
---
...
**Get Rube MCP**: Add `https://rube.app/mcp` as an MCP server in your client configuration. No API keys needed Ã¢â‚¬â€ just add the endpoint and it works.
