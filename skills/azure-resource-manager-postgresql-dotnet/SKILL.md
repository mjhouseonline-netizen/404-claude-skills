...
description: |
source_group: skills
imported_from: azure-resource-manager-postgresql-dotnet.md
...
```
Subscription
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ResourceGroup
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ PostgreSqlFlexibleServer              # PostgreSQL Flexible Server instance
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ PostgreSqlFlexibleServerDatabase  # Database within the server
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ PostgreSqlFlexibleServerFirewallRule # IP firewall rules
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ PostgreSqlFlexibleServerConfiguration # Server parameters
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ PostgreSqlFlexibleServerBackup    # Backup information
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ PostgreSqlFlexibleServerActiveDirectoryAdministrator # Entra ID admin
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ PostgreSqlFlexibleServerVirtualEndpoint # Read replica endpoints
```
...
1. **Use Flexible Server** Ã¢â‚¬â€ Single Server is deprecated
2. **Enable zone-redundant HA** Ã¢â‚¬â€ For production workloads
3. **Use DefaultAzureCredential** Ã¢â‚¬â€ Prefer over connection strings
4. **Configure Entra ID authentication** Ã¢â‚¬â€ More secure than SQL auth alone
5. **Enable both auth methods** Ã¢â‚¬â€ Entra ID + password for flexibility
6. **Set appropriate backup retention** Ã¢â‚¬â€ 7-35 days based on compliance
7. **Use private endpoints** Ã¢â‚¬â€ For secure network access
8. **Tune server parameters** Ã¢â‚¬â€ Based on workload characteristics
9. **Use read replicas** Ã¢â‚¬â€ For read-heavy workloads
10. **Stop dev/test servers** Ã¢â‚¬â€ Save costs when not in use
