...
description: |
source_group: skills
imported_from: azure-keyvault-keys-rust.md
...
Client library for Azure Key Vault Keys Ã¢â‚¬â€ secure storage and management of cryptographic keys.
...
2. **Use HSM keys for sensitive workloads** Ã¢â‚¬â€ hardware-protected keys
3. **Use EC for signing** Ã¢â‚¬â€ more efficient than RSA
4. **Use RSA for encryption** Ã¢â‚¬â€ when encrypting data
5. **Backup keys** Ã¢â‚¬â€ for disaster recovery
6. **Enable soft delete** Ã¢â‚¬â€ required for production vaults
7. **Use key rotation** Ã¢â‚¬â€ create new versions periodically

## RBAC Permissions

Assign these Key Vault roles:
- `Key Vault Crypto User` Ã¢â‚¬â€ use keys for crypto operations
- `Key Vault Crypto Officer` Ã¢â‚¬â€ full CRUD on keys
