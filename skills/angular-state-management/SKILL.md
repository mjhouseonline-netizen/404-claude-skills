...
description: Imported skill package from starter-bundle: angular-state-management. Review and refine before production use.
source_group: skills
imported_from: angular-state-management.md
---
