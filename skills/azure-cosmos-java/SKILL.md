...
description: |
source_group: skills
imported_from: azure-cosmos-java.md
...
1. **Reuse CosmosClient** Ã¢â‚¬â€ Create once, reuse throughout application
2. **Use async client** for high-throughput scenarios
3. **Choose partition key carefully** Ã¢â‚¬â€ Affects performance and scalability
