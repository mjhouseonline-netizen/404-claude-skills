...
description: |
source_group: skills
imported_from: azure-ai-document-intelligence-dotnet.md
...
2. **Reuse client instances** Ã¢â‚¬â€ clients are thread-safe
3. **Handle long-running operations** Ã¢â‚¬â€ Use `WaitUntil.Completed` for simplicity
4. **Check field confidence** Ã¢â‚¬â€ Always verify `Confidence` property
5. **Use appropriate model** Ã¢â‚¬â€ Prebuilt for common docs, custom for specialized
6. **Use custom subdomain** Ã¢â‚¬â€ Required for Entra ID authentication
