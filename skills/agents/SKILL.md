---
name: agents
description: Imported skill package from starter-bundle: AGENTS. Review and refine before production use.
source_group: skills
...
Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ marketplace.json   # Claude Code plugin marketplace manifest
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ skills/                # Agent Skills
Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ skill-name/
Ã¢â€â€š       Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ SKILL.md       # Required skill file
...
```
skills/skill-name/
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ SKILL.md        # Required - main instructions (<500 lines)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ references/     # Optional - detailed docs loaded on demand
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ scripts/        # Optional - executable code
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ assets/         # Optional - templates, data files
```
...
```
tools/
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ REGISTRY.md              # Index of all tools with capabilities
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ integrations/            # Detailed integration guides
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ ga4.md
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ stripe.md
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ rewardful.md
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ...
```
...
- `referral-program` skill Ã¢â€ â€™ rewardful, tolt, dub-co, mention-me guides
- `analytics-tracking` skill Ã¢â€ â€™ ga4, mixpanel, segment guides
- `email-sequence` skill Ã¢â€ â€™ customer-io, mailchimp, resend guides
- `paid-ads` skill Ã¢â€ â€™ google-ads, meta-ads, linkedin-ads guides
