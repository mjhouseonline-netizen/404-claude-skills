...
source_group: skills
imported_from: backtest-expert.md
---
...
- No external data dependencies Ã¢â‚¬â€ metrics are user-provided
...
- Vary entry/exit timing by Ã‚Â±15-30 minutes
...
**Decision criteria**:
- Ã¢Å“â€¦ **Deploy**: Survives all stress tests with acceptable performance
- Ã°Å¸â€â€ž **Refine**: Core logic sound but needs parameter adjustment
- Ã¢ÂÅ’ **Abandon**: Fails stress tests or relies on fragile assumptions
...
- `reports/backtest_eval_<timestamp>.json` Ã¢â‚¬â€ structured evaluation with per-dimension scores, red flags, and verdict
- `reports/backtest_eval_<timestamp>.md` Ã¢â‚¬â€ human-readable report with dimension table, key metrics, and red flag details
...
Discretionary traders study differentlyÃ¢â‚¬â€this skill may not apply to setups requiring subjective judgment.
