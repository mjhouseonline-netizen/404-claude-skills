...
description: |
source_group: skills
imported_from: azure-ai-openai-dotnet.md
...
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetChatClient(deploymentName)      Ã¢â€ â€™ ChatClient
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetEmbeddingClient(deploymentName) Ã¢â€ â€™ EmbeddingClient
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetImageClient(deploymentName)     Ã¢â€ â€™ ImageClient
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetAudioClient(deploymentName)     Ã¢â€ â€™ AudioClient
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ GetAssistantClient()               Ã¢â€ â€™ AssistantClient
```
...
1. **Use Entra ID in production** Ã¢â‚¬â€ Avoid API keys; use `DefaultAzureCredential`
2. **Reuse client instances** Ã¢â‚¬â€ Create once, share across requests
3. **Handle rate limits** Ã¢â‚¬â€ Implement exponential backoff for 429 errors
4. **Stream for long responses** Ã¢â‚¬â€ Use `CompleteChatStreamingAsync` for better UX
5. **Set appropriate timeouts** Ã¢â‚¬â€ Long completions may need extended timeouts
6. **Use structured outputs** Ã¢â‚¬â€ JSON schema ensures consistent response format
7. **Monitor token usage** Ã¢â‚¬â€ Track `completion.Usage` for cost management
8. **Validate tool calls** Ã¢â‚¬â€ Always validate function arguments before execution
...
| Migration Guide (1.0Ã¢â€ â€™2.0) | https://learn.microsoft.com/azure/ai-services/openai/how-to/dotnet-migration |
