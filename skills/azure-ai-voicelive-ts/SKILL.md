...
description: |
source_group: skills
imported_from: azure-ai-voicelive-ts.md
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ VoiceLiveSession (WebSocket connection)
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ updateSession()      Ã¢â€ â€™ Configure session options
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ subscribe()          Ã¢â€ â€™ Event handlers (Azure SDK pattern)
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ sendAudio()          Ã¢â€ â€™ Stream audio input
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ addConversationItem() Ã¢â€ â€™ Add messages/function outputs
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ sendEvent()          Ã¢â€ â€™ Send raw protocol events
```
...
1. **Always use `DefaultAzureCredential`** Ã¢â‚¬â€ Never hardcode API keys
2. **Set both modalities** Ã¢â‚¬â€ Include `["text", "audio"]` for voice assistants
3. **Use Azure Semantic VAD** Ã¢â‚¬â€ Better turn detection than basic server VAD
4. **Handle all error types** Ã¢â‚¬â€ Connection, auth, and protocol errors
5. **Clean up subscriptions** Ã¢â‚¬â€ Call `subscription.close()` when done
6. **Use appropriate audio format** Ã¢â‚¬â€ PCM16 at 24kHz for best quality
