...
description: |
source_group: skills
imported_from: azure-monitor-query-java.md
...
> - `azure-monitor-query-logs` Ã¢â‚¬â€ For Log Analytics queries
> - `azure-monitor-query-metrics` Ã¢â‚¬â€ For metrics queries
>
...
```
LogsQueryResult
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ statistics (BinaryData)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ visualization (BinaryData)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ error
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ tables (List<LogsTable>)
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ name
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ columns (List<LogsTableColumn>)
    Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ name
    Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ type
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ rows (List<LogsTableRow>)
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ rowIndex
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ rowCells (List<LogsTableCell>)
```
...
```
MetricsQueryResult
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ granularity
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ timeInterval
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ namespace
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ resourceRegion
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ metrics (List<MetricResult>)
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ id, name, type, unit
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ timeSeries (List<TimeSeriesElement>)
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ metadata (dimensions)
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ values (List<MetricValue>)
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ timeStamp
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ count, average, total
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ maximum, minimum
```
...
1. **Use batch queries** Ã¢â‚¬â€ Combine multiple queries into a single request
2. **Set appropriate timeouts** Ã¢â‚¬â€ Long queries may need extended server timeout
3. **Limit result size** Ã¢â‚¬â€ Use `top` or `take` in Kusto queries
4. **Use projections** Ã¢â‚¬â€ Select only needed columns with `project`
5. **Check query status** Ã¢â‚¬â€ Handle PARTIAL_FAILURE results gracefully
6. **Cache results** Ã¢â‚¬â€ Metrics don't change frequently; cache when appropriate
7. **Migrate to new packages** Ã¢â‚¬â€ Plan migration to `azure-monitor-query-logs` and `azure-monitor-query-metrics`
