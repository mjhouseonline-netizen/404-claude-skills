...
description: |
source_group: skills
imported_from: azure-security-keyvault-keys-dotnet.md
...
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ CreateKey / CreateRsaKey / CreateEcKey
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetKey / GetKeys
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ UpdateKeyProperties
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ DeleteKey / PurgeDeletedKey
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ BackupKey / RestoreKey
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ GetCryptographyClient() Ã¢â€ â€™ CryptographyClient

CryptographyClient (cryptographic operations)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Encrypt / Decrypt
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ WrapKey / UnwrapKey
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Sign / Verify
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ SignData / VerifyData

KeyResolver (key resolution)
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ Resolve(keyId) Ã¢â€ â€™ CryptographyClient
```
...
1. **Use Managed Identity** Ã¢â‚¬â€ Prefer `DefaultAzureCredential` over secrets
2. **Enable soft-delete** Ã¢â‚¬â€ Protect against accidental deletion
3. **Use HSM-backed keys** Ã¢â‚¬â€ Set `HardwareProtected = true` for sensitive keys
4. **Implement key rotation** Ã¢â‚¬â€ Use automatic rotation policies
5. **Limit key operations** Ã¢â‚¬â€ Only enable required `KeyOperations`
6. **Set expiration dates** Ã¢â‚¬â€ Always set `ExpiresOn` for keys
7. **Use specific versions** Ã¢â‚¬â€ Pin to versions in production
8. **Cache CryptographyClient** Ã¢â‚¬â€ Reuse for multiple operations
