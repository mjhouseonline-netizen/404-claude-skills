...
description: >
source_group: skills
imported_from: ads-competitor.md
...
| Microsoft Ads | Microsoft | Limited Ã¢â‚¬â€ use auction insights |
...
- No per-advertiser library Ã¢â‚¬â€ use Creative Center for industry trends
...
|-------|-------------|-------------|------------|
| Price/Value | Ã¢Å“â€¦ Primary | Ã¢Å¡Â Ã¯Â¸Â Secondary | ? |
| Quality/Premium | Ã¢ÂÅ’ | Ã¢Å“â€¦ Primary | ? |
| Speed/Convenience | Ã¢Å¡Â Ã¯Â¸Â Secondary | Ã¢ÂÅ’ | ? |
| Trust/Authority | Ã¢Å“â€¦ Primary | Ã¢Å“â€¦ Primary | ? |
| Innovation | Ã¢ÂÅ’ | Ã¢Å¡Â Ã¯Â¸Â Secondary | ? |
...
- Manual estimation formula:
  ```
  Estimated Monthly Spend = Impressions Ãƒâ€” CPM / 1000
  or
  Estimated Monthly Spend = Clicks Ãƒâ€” Estimated CPC
  ```
...
### Deliverables
- `COMPETITOR-INTELLIGENCE-REPORT.md` Ã¢â‚¬â€ Full competitive analysis
...
- `COMPETITIVE-GAPS.md` Ã¢â‚¬â€ Opportunities identified from competitor analysis
  - Platform gaps
