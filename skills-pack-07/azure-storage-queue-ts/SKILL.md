...
description: |
source_group: skills
imported_from: azure-storage-queue-ts.md
...
SDK for Azure Queue Storage operations Ã¢â‚¬â€ send, receive, peek, and manage messages in queues.
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ QueueClient (queue level)
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ Messages (send, receive, peek, delete)
```
...
2. **Always delete after processing** Ã¢â‚¬â€ Prevent duplicate processing
3. **Handle poison messages** Ã¢â‚¬â€ Move failed messages to a dead-letter queue
4. **Use appropriate visibility timeout** Ã¢â‚¬â€ Set based on expected processing time
5. **Extend visibility for long tasks** Ã¢â‚¬â€ Update message to prevent timeout
6. **Use JSON for structured data** Ã¢â‚¬â€ Serialize objects to JSON strings
7. **Check dequeueCount** Ã¢â‚¬â€ Detect repeatedly failing messages
8. **Use batch receive** Ã¢â‚¬â€ Receive multiple messages for efficiency
...
| All message operations | Ã¢Å“â€¦ | Ã¢Å“â€¦ |
