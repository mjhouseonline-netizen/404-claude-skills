...
description: |
source_group: skills
imported_from: azure-maps-search-dotnet.md
...
```
Azure.Maps.Search
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ MapsSearchClient
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetGeocoding()                    Ã¢â€ â€™ Geocode addresses
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetGeocodingBatch()               Ã¢â€ â€™ Batch geocoding
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetReverseGeocoding()             Ã¢â€ â€™ Coordinates to address
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetReverseGeocodingBatch()        Ã¢â€ â€™ Batch reverse geocoding
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ GetPolygon()                      Ã¢â€ â€™ Get boundary polygons

Azure.Maps.Routing
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ MapsRoutingClient
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetDirections()                   Ã¢â€ â€™ Route directions
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetImmediateRouteMatrix()         Ã¢â€ â€™ Route matrix (sync, Ã¢â€°Â¤100)
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetRouteMatrix()                  Ã¢â€ â€™ Route matrix (async, Ã¢â€°Â¤700)
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ GetRouteRange()                   Ã¢â€ â€™ Isochrone/reachable range

Azure.Maps.Rendering
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ MapsRenderingClient
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetMapTile()                      Ã¢â€ â€™ Map tiles
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetMapStaticImage()               Ã¢â€ â€™ Static map images
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ GetCopyrightCaption()             Ã¢â€ â€™ Copyright info

Azure.Maps.Geolocation
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ MapsGeolocationClient
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ GetCountryCode()                  Ã¢â€ â€™ IP to country/region

Azure.Maps.Weather
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ MapsWeatherClient
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetCurrentWeatherConditions()     Ã¢â€ â€™ Current weather
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetDailyForecast()                Ã¢â€ â€™ Daily forecast
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ GetHourlyForecast()               Ã¢â€ â€™ Hourly forecast
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ GetSevereWeatherAlerts()          Ã¢â€ â€™ Weather alerts
```
...
1. **Use Entra ID for production** Ã¢â‚¬â€ Prefer over subscription keys
2. **Batch operations** Ã¢â‚¬â€ Use batch geocoding for multiple addresses
3. **Cache results** Ã¢â‚¬â€ Geocoding results don't change frequently
4. **Use appropriate tile sizes** Ã¢â‚¬â€ 256 or 512 pixels based on display
5. **Handle rate limits** Ã¢â‚¬â€ Implement exponential backoff
6. **Use async route matrix** Ã¢â‚¬â€ For large matrix calculations (>100)
7. **Consider traffic data** Ã¢â‚¬â€ Set `UseTrafficData = true` for accurate ETAs
