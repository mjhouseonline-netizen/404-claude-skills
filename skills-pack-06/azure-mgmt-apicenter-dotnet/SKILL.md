...
description: |
source_group: skills
imported_from: azure-mgmt-apicenter-dotnet.md
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ResourceGroup
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ApiCenterService                    # API inventory service
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Workspace                       # Logical grouping of APIs
        Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Api                         # API definition
        Ã¢â€â€š   Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ApiVersion              # Version of the API
        Ã¢â€â€š   Ã¢â€â€š       Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ApiDefinition       # OpenAPI/GraphQL/etc specification
        Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Environment                 # Deployment target (dev/staging/prod)
        Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ Deployment                  # API deployed to environment
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ MetadataSchema                  # Custom metadata definitions
```
...
1. **Organize with workspaces** Ã¢â‚¬â€ Group APIs by team, domain, or product
2. **Use metadata schemas** Ã¢â‚¬â€ Define custom properties for governance
3. **Track lifecycle stages** Ã¢â‚¬â€ Keep API status current (design Ã¢â€ â€™ production Ã¢â€ â€™ deprecated)
4. **Document environments** Ã¢â‚¬â€ Include onboarding instructions and portal URIs
5. **Version consistently** Ã¢â‚¬â€ Use semantic versioning for API versions
6. **Import specifications** Ã¢â‚¬â€ Upload OpenAPI/GraphQL specs for discovery
7. **Link deployments** Ã¢â‚¬â€ Connect APIs to their runtime environments
8. **Use managed identity** Ã¢â‚¬â€ Enable SystemAssigned identity for secure integrations
