...
description: |
source_group: skills
imported_from: azure-mgmt-fabric-py.md
...
6. **Handle LRO properly** Ã¢â‚¬â€ don't assume immediate completion
7. **Set up capacity admins** Ã¢â‚¬â€ specify users who can manage workspaces
