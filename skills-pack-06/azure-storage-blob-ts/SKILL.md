...
description: |
source_group: skills
imported_from: azure-storage-blob-ts.md
...
SDK for Azure Blob Storage operations Ã¢â‚¬â€ upload, download, list, and manage blobs and containers.
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ContainerClient (container level)
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ BlobClient (blob level)
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ BlockBlobClient (block blobs - most common)
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ AppendBlobClient (append-only blobs)
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ PageBlobClient (page blobs - VHDs)
```
...
1. **Use DefaultAzureCredential** Ã¢â‚¬â€ Prefer AAD over connection strings/keys
2. **Use streaming for large files** Ã¢â‚¬â€ `uploadStream`/`downloadToFile` for files > 256MB
3. **Set appropriate content types** Ã¢â‚¬â€ Use `setHTTPHeaders` for correct MIME types
4. **Use SAS tokens for client access** Ã¢â‚¬â€ Generate short-lived tokens for browser uploads
5. **Handle errors gracefully** Ã¢â‚¬â€ Check `RestError.statusCode` for specific handling
6. **Use `*IfNotExists` methods** Ã¢â‚¬â€ For idempotent container/blob creation
7. **Close clients** Ã¢â‚¬â€ Not required but good practice in long-running apps

## Platform Differences

| Feature | Node.js | Browser |
|---------|---------|---------|
| `StorageSharedKeyCredential` | Ã¢Å“â€¦ | Ã¢ÂÅ’ |
| `uploadFile()` | Ã¢Å“â€¦ | Ã¢ÂÅ’ |
| `uploadStream()` | Ã¢Å“â€¦ | Ã¢ÂÅ’ |
| `downloadToFile()` | Ã¢Å“â€¦ | Ã¢ÂÅ’ |
| `downloadToBuffer()` | Ã¢Å“â€¦ | Ã¢ÂÅ’ |
| `uploadData()` | Ã¢Å“â€¦ | Ã¢Å“â€¦ |
| SAS generation | Ã¢Å“â€¦ | Ã¢ÂÅ’ |
| DefaultAzureCredential | Ã¢Å“â€¦ | Ã¢ÂÅ’ |
| Anonymous/SAS access | Ã¢Å“â€¦ | Ã¢Å“â€¦ |
