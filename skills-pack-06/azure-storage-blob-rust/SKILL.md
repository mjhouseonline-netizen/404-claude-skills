...
description: |
source_group: skills
imported_from: azure-storage-blob-rust.md
...
Client library for Azure Blob Storage Ã¢â‚¬â€ Microsoft's object storage solution for the cloud.
...
2. **Specify content length** Ã¢â‚¬â€ required for uploads
3. **Use `RequestContent::from()`** Ã¢â‚¬â€ to wrap upload data
4. **Handle async operations** Ã¢â‚¬â€ use `tokio` runtime
5. **Check RBAC permissions** Ã¢â‚¬â€ ensure "Storage Blob Data Contributor" role

## RBAC Permissions

For Entra ID auth, assign one of these roles:
- `Storage Blob Data Reader` Ã¢â‚¬â€ read-only
- `Storage Blob Data Contributor` Ã¢â‚¬â€ read/write
- `Storage Blob Data Owner` Ã¢â‚¬â€ full access including RBAC
