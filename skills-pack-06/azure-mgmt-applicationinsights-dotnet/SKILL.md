...
description: |
source_group: skills
imported_from: azure-mgmt-applicationinsights-dotnet.md
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ResourceGroup
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ApplicationInsightsComponent          # App Insights resource
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ ApplicationInsightsComponentApiKey  # API keys for programmatic access
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ ComponentLinkedStorageAccount      # Linked storage for data export
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ (via component ID)
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ WebTest                        # Availability tests
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Workbook                       # Workbooks for analysis
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ WorkbookTemplate               # Workbook templates
            Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ MyWorkbook                     # Private workbooks
```
...
1. **Use workspace-based** Ã¢â‚¬â€ Workspace-based App Insights is the current standard
2. **Link to Log Analytics** Ã¢â‚¬â€ Store data in Log Analytics for better querying
3. **Set appropriate retention** Ã¢â‚¬â€ Balance cost vs. data availability
4. **Use sampling** Ã¢â‚¬â€ Reduce costs for high-volume applications
5. **Store connection string securely** Ã¢â‚¬â€ Use Key Vault or managed identity
6. **Enable multiple test locations** Ã¢â‚¬â€ For accurate availability monitoring
7. **Use workbooks** Ã¢â‚¬â€ For custom dashboards and analysis
8. **Set up alerts** Ã¢â‚¬â€ Based on availability tests and metrics
9. **Tag resources** Ã¢â‚¬â€ For cost allocation and organization
10. **Use private endpoints** Ã¢â‚¬â€ For secure data ingestion
