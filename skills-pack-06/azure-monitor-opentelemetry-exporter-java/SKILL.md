...
description: |
source_group: skills
imported_from: azure-monitor-opentelemetry-exporter-java.md
...
> **Ã¢Å¡Â Ã¯Â¸Â DEPRECATION NOTICE**: This package is deprecated. Migrate to `azure-monitor-opentelemetry-autoconfigure`.
>
...
1. **Use autoconfigure** Ã¢â‚¬â€ Migrate to `azure-monitor-opentelemetry-autoconfigure`
2. **Set meaningful span names** Ã¢â‚¬â€ Use descriptive operation names
3. **Add relevant attributes** Ã¢â‚¬â€ Include contextual data for debugging
4. **Handle exceptions** Ã¢â‚¬â€ Always record exceptions on spans
5. **Use semantic conventions** Ã¢â‚¬â€ Follow OpenTelemetry semantic conventions
6. **End spans in finally** Ã¢â‚¬â€ Ensure spans are always ended
7. **Use try-with-resources** Ã¢â‚¬â€ Scope management with try-with-resources pattern
