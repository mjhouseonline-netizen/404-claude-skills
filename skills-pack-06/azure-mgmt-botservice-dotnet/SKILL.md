...
description: |
source_group: skills
imported_from: azure-mgmt-botservice-dotnet.md
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ SubscriptionResource
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ResourceGroupResource
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ BotResource
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ BotChannelResource (DirectLine, Teams, Slack, etc.)
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ BotConnectionSettingResource (OAuth connections)
            Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ BotServicePrivateEndpointConnectionResource
```
...
1. **Always use `DefaultAzureCredential`** Ã¢â‚¬â€ supports multiple auth methods
...
5. **Store MSA App credentials securely** Ã¢â‚¬â€ use Key Vault for secrets
