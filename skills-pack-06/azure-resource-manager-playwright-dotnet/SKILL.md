...
description: |
source_group: skills
imported_from: azure-resource-manager-playwright-dotnet.md
...
> **Ã¢Å¡Â Ã¯Â¸Â Management vs Test Execution**
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ SubscriptionResource
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ PlaywrightQuotaResource (subscription-level quotas)
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ResourceGroupResource
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ PlaywrightWorkspaceResource
            Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ PlaywrightWorkspaceQuotaResource (workspace-level quotas)
```
