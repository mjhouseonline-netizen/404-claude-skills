...
description: |
source_group: skills
imported_from: azure-mgmt-weightsandbiases-dotnet.md
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ResourceGroup
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ WeightsAndBiasesInstance    # W&B deployment from Azure Marketplace
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Properties
        Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Marketplace          # Offer details, plan, publisher
        Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ User                 # Admin user info
        Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ PartnerProperties    # W&B-specific config (region, subdomain)
        Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ SingleSignOnPropertiesV2  # Entra ID SSO configuration
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ Identity                 # Managed identity (optional)
```
...
1. **Use DefaultAzureCredential** Ã¢â‚¬â€ Supports multiple auth methods automatically
2. **Enable managed identity** Ã¢â‚¬â€ For secure access to other Azure resources
3. **Configure SSO** Ã¢â‚¬â€ Enable Entra ID SSO for enterprise security
4. **Tag resources** Ã¢â‚¬â€ Use tags for cost tracking and organization
5. **Check provisioning state** Ã¢â‚¬â€ Wait for `Succeeded` before using instance
6. **Use appropriate region** Ã¢â‚¬â€ Choose region closest to your compute
7. **Monitor with Azure** Ã¢â‚¬â€ Use Azure Monitor for resource health
