...
description: |
source_group: skills
imported_from: azure-resource-manager-mysql-dotnet.md
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ResourceGroup
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ MySqlFlexibleServer                 # MySQL Flexible Server instance
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ MySqlFlexibleServerDatabase     # Database within the server
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ MySqlFlexibleServerFirewallRule # IP firewall rules
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ MySqlFlexibleServerConfiguration # Server parameters
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ MySqlFlexibleServerBackup       # Backup information
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ MySqlFlexibleServerMaintenanceWindow # Maintenance schedule
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ MySqlFlexibleServerAadAdministrator # Entra ID admin
```
...
4. **Configure Entra ID authentication** Ã¢â‚¬â€ More secure than SQL auth
5. **Enable auto-grow storage** Ã¢â‚¬â€ Prevents out-of-space issues
...
9. **Monitor with Azure Monitor** Ã¢â‚¬â€ Enable metrics and logs
