...
description: |
source_group: skills
imported_from: azure-servicebus-dotnet.md
...
```
ServiceBusClient
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ CreateSender(queueOrTopicName)      Ã¢â€ â€™ ServiceBusSender
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ CreateReceiver(queueName)           Ã¢â€ â€™ ServiceBusReceiver
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ CreateReceiver(topicName, subName)  Ã¢â€ â€™ ServiceBusReceiver
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ AcceptNextSessionAsync(queueName)   Ã¢â€ â€™ ServiceBusSessionReceiver
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ CreateProcessor(queueName)          Ã¢â€ â€™ ServiceBusProcessor
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ CreateSessionProcessor(queueName)   Ã¢â€ â€™ ServiceBusSessionProcessor
...
1. **Use singletons** Ã¢â‚¬â€ Clients, senders, receivers, and processors are thread-safe
2. **Always dispose** Ã¢â‚¬â€ Use `await using` or call `DisposeAsync()`
3. **Dispose order** Ã¢â‚¬â€ Close senders/receivers/processors first, then client
4. **Use DefaultAzureCredential** Ã¢â‚¬â€ Prefer over connection strings for production
5. **Use processors for background work** Ã¢â‚¬â€ Handles lock renewal automatically
6. **Use safe batching** Ã¢â‚¬â€ `CreateMessageBatchAsync()` and `TryAddMessage()`
7. **Handle transient errors** Ã¢â‚¬â€ Use `ServiceBusException.Reason`
8. **Configure transport** Ã¢â‚¬â€ Use `AmqpWebSockets` if ports 5671/5672 are blocked
9. **Set appropriate lock duration** Ã¢â‚¬â€ Default is 30 seconds
10. **Use sessions for ordering** Ã¢â‚¬â€ FIFO within a session
