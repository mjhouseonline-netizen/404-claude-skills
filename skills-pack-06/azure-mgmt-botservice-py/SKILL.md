...
description: |
source_group: skills
imported_from: azure-mgmt-botservice-py.md
...
3. **Store MSA App ID/Secret securely** Ã¢â‚¬â€ use Key Vault
4. **Enable only needed channels** Ã¢â‚¬â€ reduces attack surface
