...
description: |
source_group: skills
imported_from: azure-resource-manager-durabletask-dotnet.md
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ SubscriptionResource
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ResourceGroupResource
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ DurableTaskSchedulerResource
            Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ DurableTaskHubResource
            Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ DurableTaskRetentionPolicyResource
```
...
6. **Delete task hubs before schedulers** Ã¢â‚¬â€ schedulers with task hubs cannot be deleted
