...
description: |
source_group: skills
imported_from: azure-eventgrid-dotnet.md
...
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ EventGridPublisherClient
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ SendEventAsync(EventGridEvent)
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ SendEventsAsync(IEnumerable<EventGridEvent>)
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ SendEventAsync(CloudEvent)
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ SendEventsAsync(IEnumerable<CloudEvent>)

Pull Delivery (Namespaces)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ EventGridSenderClient
Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ SendAsync(CloudEvent)
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ EventGridReceiverClient
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ ReceiveAsync()
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ AcknowledgeAsync()
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ ReleaseAsync()
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ RejectAsync()
```
...
1. **Use CloudEvents** Ã¢â‚¬â€ Prefer CloudEvents for new implementations (industry standard)
2. **Batch events** Ã¢â‚¬â€ Send multiple events in one call for efficiency
3. **Use Entra ID** Ã¢â‚¬â€ Prefer managed identity over access keys
4. **Idempotent handlers** Ã¢â‚¬â€ Events may be delivered more than once
5. **Set event TTL** Ã¢â‚¬â€ Configure time-to-live for namespace events
6. **Handle partial failures** Ã¢â‚¬â€ Acknowledge/release events individually
7. **Use dead-letter** Ã¢â‚¬â€ Configure dead-letter for failed events
8. **Validate schemas** Ã¢â‚¬â€ Validate event data before processing
