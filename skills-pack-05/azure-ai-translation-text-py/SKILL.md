...
description: |
source_group: skills
imported_from: azure-ai-translation-text-py.md
...
1. **Batch translations** Ã¢â‚¬â€ Send multiple texts in one request (up to 100)
2. **Specify source language** when known to improve accuracy
3. **Use async client** for high-throughput scenarios
4. **Cache language list** Ã¢â‚¬â€ Supported languages don't change frequently
