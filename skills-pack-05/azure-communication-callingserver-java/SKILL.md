...
source_group: skills
imported_from: azure-communication-callingserver-java.md
package: com.azure:azure-communication-callingserver
---

# Azure Communication CallingServer (Java) - DEPRECATED

> **Ã¢Å¡Â Ã¯Â¸Â DEPRECATED**: This SDK has been renamed to **Call Automation**. For new projects, use `azure-communication-callautomation` instead. This skill is for maintaining legacy code only.
