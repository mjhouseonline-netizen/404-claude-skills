...
description: Imported skill package from starter-bundle: audio-transcriber. Review and refine before production use.
source_group: skills
imported_from: audio-transcriber.md
---
...
- **Intelligent Prompt Workflow** (Step 3b) - Complete integration with prompt-engineer skill
  - **Scenario A**: User-provided prompts are automatically improved with prompt-engineer
    ...
    - Single confirmation: "Usar versÃƒÂ£o melhorada? [s/n]"
...
### Ã°Å¸â€â€” Related Issues

- Fixes #1: Prompt do usuÃƒÂ¡rio RISEN ignorado
- Fixes #2: Arquivos temporÃƒÂ¡rios (metadata.json, transcription.json) deixados como lixo
- Fixes #3: Output incompleto (apenas transcript RAW, sem ata)
- Fixes #4: Falta de indicador de progresso visual
- Fixes #5: Formato de saÃƒÂ­da sem timestamp

---

## [1.0.0] - 2026-02-02

### Ã¢Å“Â¨ Initial Release
...
### Ã°Å¸â€œÂ Known Limitations (Fixed in v1.1.0)
