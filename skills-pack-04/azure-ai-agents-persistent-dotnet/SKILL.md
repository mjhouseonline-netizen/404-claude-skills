...
description: |
source_group: skills
imported_from: azure-ai-agents-persistent-dotnet.md
...
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Administration  Ã¢â€ â€™ Agent CRUD operations
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Threads         Ã¢â€ â€™ Thread management
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Messages        Ã¢â€ â€™ Message operations
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Runs            Ã¢â€ â€™ Run execution and streaming
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ Files           Ã¢â€ â€™ File upload/download
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ VectorStores    Ã¢â€ â€™ Vector store management
```
...
1. **Always dispose clients** Ã¢â‚¬â€ Use `using` statements or explicit disposal
2. **Poll with appropriate delays** Ã¢â‚¬â€ 500ms recommended between status checks
3. **Clean up resources** Ã¢â‚¬â€ Delete threads and agents when done
4. **Handle all run statuses** Ã¢â‚¬â€ Check for `RequiresAction`, `Failed`, `Cancelled`
5. **Use streaming for real-time UX** Ã¢â‚¬â€ Better user experience than polling
6. **Store IDs not objects** Ã¢â‚¬â€ Reference agents/threads by ID
7. **Use async methods** Ã¢â‚¬â€ All operations should be async
