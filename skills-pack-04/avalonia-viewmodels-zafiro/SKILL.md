...
description: Imported skill package from starter-bundle: avalonia-viewmodels-zafiro. Review and refine before production use.
source_group: skills
imported_from: avalonia-viewmodels-zafiro.md
---
