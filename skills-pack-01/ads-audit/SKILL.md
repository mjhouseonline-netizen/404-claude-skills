...
1. **Collect account data** Ã¢â‚¬â€ request exports, screenshots, or API access
2. **Detect business type** Ã¢â‚¬â€ analyze account signals per ads orchestrator
3. **Identify active platforms** Ã¢â‚¬â€ determine which platforms are in use
4. **Delegate to subagents** (if available, otherwise run inline sequentially):
   - `audit-google` Ã¢â‚¬â€ Conversion tracking, wasted spend, structure, keywords, ads, settings (G01-G74)
   - `audit-meta` Ã¢â‚¬â€ Pixel/CAPI health, creative fatigue, structure, audience (M01-M46)
   - `audit-creative` Ã¢â‚¬â€ LinkedIn, TikTok, Microsoft creative checks + cross-platform synthesis
   - `audit-tracking` Ã¢â‚¬â€ LinkedIn, TikTok, Microsoft tracking + cross-platform tracking health
   - `audit-budget` Ã¢â‚¬â€ LinkedIn, TikTok, Microsoft budget/bidding + cross-platform allocation
   - `audit-compliance` Ã¢â‚¬â€ All-platform compliance, settings, performance benchmarks
5. **Score** Ã¢â‚¬â€ calculate per-platform and aggregate Ads Health Score (0-100)
6. **Report** Ã¢â‚¬â€ generate prioritized action plan with Quick Wins
...
- `ADS-AUDIT-REPORT.md` Ã¢â‚¬â€ Comprehensive multi-platform findings
- `ADS-ACTION-PLAN.md` Ã¢â‚¬â€ Prioritized recommendations (Critical > High > Medium > Low)
- `ADS-QUICK-WINS.md` Ã¢â‚¬â€ Items fixable in <15 minutes with high impact
