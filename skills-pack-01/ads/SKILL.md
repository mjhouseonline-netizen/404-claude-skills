...
# Ads Ã¢â‚¬â€ Multi-Platform Paid Advertising Audit & Optimization
...
Hard rules Ã¢â‚¬â€ never violate these:
- Never recommend Broad Match without Smart Bidding (Google)
- 3x Kill Rule: flag any ad group/campaign with CPA >3x target for pause
- Budget sufficiency: Meta Ã¢â€°Â¥5x CPA per ad set, TikTok Ã¢â€°Â¥50x CPA per ad group
...
Load these on-demand as needed Ã¢â‚¬â€ do NOT load all at startup.
...
- `references/scoring-system.md` Ã¢â‚¬â€ Weighted scoring algorithm and grading thresholds
- `references/benchmarks.md` Ã¢â‚¬â€ Industry benchmarks by platform (CPC, CTR, CVR, ROAS)
- `references/bidding-strategies.md` Ã¢â‚¬â€ Bidding decision trees per platform
- `references/budget-allocation.md` Ã¢â‚¬â€ Platform selection matrix, scaling rules, MER
- `references/platform-specs.md` Ã¢â‚¬â€ Creative specifications across all platforms
- `references/conversion-tracking.md` Ã¢â‚¬â€ Pixel, CAPI, EMQ, ttclid implementation
- `references/compliance.md` Ã¢â‚¬â€ Regulatory requirements, ad policies, privacy
- `references/google-audit.md` Ã¢â‚¬â€ 74-check Google Ads audit checklist
- `references/meta-audit.md` Ã¢â‚¬â€ 46-check Meta Ads audit checklist
- `references/linkedin-audit.md` Ã¢â‚¬â€ 25-check LinkedIn Ads audit checklist
- `references/tiktok-audit.md` Ã¢â‚¬â€ 25-check TikTok Ads audit checklist
- `references/microsoft-audit.md` Ã¢â‚¬â€ 20-check Microsoft Ads audit checklist
...
1. **ads-audit** Ã¢â‚¬â€ Full multi-platform audit with parallel delegation
2. **ads-google** Ã¢â‚¬â€ Google Ads deep analysis (Search, PMax, YouTube)
3. **ads-meta** Ã¢â‚¬â€ Meta Ads deep analysis (FB, IG, Advantage+)
4. **ads-youtube** Ã¢â‚¬â€ YouTube Ads specific analysis
5. **ads-linkedin** Ã¢â‚¬â€ LinkedIn Ads deep analysis
6. **ads-tiktok** Ã¢â‚¬â€ TikTok Ads deep analysis
7. **ads-microsoft** Ã¢â‚¬â€ Microsoft/Bing Ads deep analysis
8. **ads-creative** Ã¢â‚¬â€ Cross-platform creative quality audit
9. **ads-landing** Ã¢â‚¬â€ Landing page quality for ad campaigns
10. **ads-budget** Ã¢â‚¬â€ Budget allocation and bidding strategy
11. **ads-plan** Ã¢â‚¬â€ Strategic ad planning with industry templates
12. **ads-competitor** Ã¢â‚¬â€ Competitor ad intelligence

## Subagents

For parallel analysis during full audits:
- `audit-google` Ã¢â‚¬â€ Google Ads checks (G01-G74)
- `audit-meta` Ã¢â‚¬â€ Meta Ads checks (M01-M46)
- `audit-creative` Ã¢â‚¬â€ Creative quality for LinkedIn, TikTok, Microsoft
- `audit-tracking` Ã¢â‚¬â€ Conversion tracking health across all platforms
- `audit-budget` Ã¢â‚¬â€ Budget, bidding, structure for LinkedIn, TikTok, Microsoft
- `audit-compliance` Ã¢â‚¬â€ Compliance, settings, performance across all platforms
