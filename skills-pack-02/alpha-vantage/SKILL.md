...
source_group: skills
imported_from: alpha-vantage.md
license: Unknown
metadata:
    skill-author: K-Dense Inc.
---

# Alpha Vantage Ã¢â‚¬â€ Financial Market Data
...
- **[time-series.md](references/time-series.md)** Ã¢â‚¬â€ Stock OHLCV data, quotes, bulk quotes, market status
- **[fundamentals.md](references/fundamentals.md)** Ã¢â‚¬â€ Company overview, financial statements, earnings, dividends, splits
- **[options.md](references/options.md)** Ã¢â‚¬â€ Realtime and historical options chain data
- **[intelligence.md](references/intelligence.md)** Ã¢â‚¬â€ News/sentiment, earnings transcripts, insider transactions, analytics
- **[forex-crypto.md](references/forex-crypto.md)** Ã¢â‚¬â€ Forex exchange rates and cryptocurrency prices
- **[commodities.md](references/commodities.md)** Ã¢â‚¬â€ Gold, silver, oil, natural gas, agricultural commodities
- **[economic-indicators.md](references/economic-indicators.md)** Ã¢â‚¬â€ GDP, CPI, interest rates, employment data
- **[technical-indicators.md](references/technical-indicators.md)** Ã¢â‚¬â€ 50+ technical analysis indicators (SMA, EMA, MACD, RSI, etc.)
