...
description: Imported skill package from starter-bundle: angular-ui-patterns. Review and refine before production use.
source_group: skills
imported_from: angular-ui-patterns.md
---
